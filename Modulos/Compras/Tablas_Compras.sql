...
ALTER TABLE COM_Producto ADD (CONSTRAINT Fk_COM_Categoria FOREIGN KEY (codigoCategoria) REFERENCES COM_Categoria(codigoCategoria));
ALTER TABLE COM_Producto ADD (CONSTRAINT Fk_COM_UnidadDeMedida FOREIGN KEY (codigoUnidad) REFERENCES COM_UnidadDeMedida(codigoUnidad));
...
ALTER TABLE COM_Detalle_Compra ADD (CONSTRAINT Fk_COM_Detalle_Compra_codigo_compra FOREIGN KEY (codigoCompra) REFERENCES COM_Orden_Compra (codigoCompra));
ALTER TABLE COM_Detalle_Compra ADD (CONSTRAINT Fk_COM_Detalle_Compra_codigo_producto FOREIGN KEY (codigoProducto) REFERENCES COM_Producto (codigoProducto));
...
ALTER TABLE COM_Historial_Compra ADD (CONSTRAINT Fk_COM_HistorialCompra_codigo_proveedor FOREIGN KEY (codigoProveedor) REFERENCES COM_Proveedor(codigoProveedor));
ALTER TABLE COM_Historial_Compra ADD (CONSTRAINT Fk_COM_HistorialCompra_codigo_producto FOREIGN KEY (codigoProducto) REFERENCES COM_Producto (codigoProducto));
...
ALTER TABLE COM_Notificacion_Compra ADD (CONSTRAINT Fk_COM_Notificacion_Compra_codigo_compra FOREIGN KEY (codigoCompra) REFERENCES COM_Orden_Compra (codigoCompra));
...
ALTER TABLE COM_Descuento ADD (CONSTRAINT Ck_COM_COM_Descuento_tipoDescuento CHECK(tipoDescuento IN ('s','n')) );
...
ALTER TABLE COM_Seguimiento_Envio ADD (CONSTRAINT Fk_COM_Seguimiento_Envio FOREIGN KEY (codigoCompra) REFERENCES COM_Orden_Compra(codigoCompra));

...
CREATE TABLE VEN_Pedidos_productos (
    ...
    CONSTRAINT FK_productoID FOREIGN KEY (productoID) REFERENCES INV_productos(productoID) ON DELETE CASCADE --Ejecutar luego de la tabla de INV
);
...
CREATE TABLE VEN_Encabezado_factura (
    ...
    ubicacionID INT,
    clienteID VARCHAR2(30),
    CONSTRAINT FK_empleadoID_encabezado FOREIGN KEY (empleadoID) REFERENCES RRHH_Empleados(empleadoID) ON DELETE CASCADE, --Ejecutar luego de la tabla de RRHH
    CONSTRAINT FK_ubicacionID_encabezado FOREIGN KEY (ubicacionID) REFERENCES INV_Ubicaciones(ubicacionID) ON DELETE CASCADE, --Ejecutar luego de la tabla de INV
...
CREATE TABLE VEN_Detalle_factura (
    ...
    CONSTRAINT FK_ProductoID_detalle FOREIGN KEY (productoID) REFERENCES INV_Productos(productoID) ON DELETE CASCADE, --Ejecutar luego de la tabla de INV
    CONSTRAINT FK_almacenID_detalle FOREIGN KEY (almacenID) REFERENCES INV_Almacenes(almacenID) ON DELETE CASCADE --Ejecutar luego de la tabla de INV
);
...
CREATE TABLE VEN_Envios (
    ...
    ubicacionID INT,
    CONSTRAINT FK_ubicacionID_envios FOREIGN KEY (ubicacionID) REFERENCES INV_Ubicaciones(ubicacionID) ON DELETE CASCADE --Ejecutar luego de la tabla de INV
);
...
CREATE TABLE VEN_Promociones (
    ...
    productoID INT,
    CONSTRAINT FK_Producto_promociones FOREIGN KEY (productoID) REFERENCES INV_Productos (productoID) ON DELETE CASCADE --Ejecutar luego de la tabla de INV
);
...
CREATE TABLE VEN_Devoluciones (
    ...
    CONSTRAINT FK_IDproducto_devoluciones FOREIGN KEY (productoID) REFERENCES INV_Productos (productoID) ON DELETE CASCADE, --Ejecutar luego de la tabla de INV
